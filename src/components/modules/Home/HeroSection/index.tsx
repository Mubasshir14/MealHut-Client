        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-12">
          <div className="flex-1">
            ...
            <p className="mb-8 text-lg text-light-text text-justify">
              Experience restaurant-quality meals prepared by top chefs,
              delivered fresh to your doorstep. Choose from weekly changing
              menus, customize your meal plans, and enjoy hassle-free cooking.
            </p>
            <div className="flex gap-4">
              <Link href="/meals">
                <div className="border-2 border-red-400 rounded p-3 text-red-400 hover:scale-105 duration-1000">
                  Explore Meals
                </div>
              </Link>
              <div onClick={() => scrollToSection("how-it-works")}>
                <p className="border-2 border-green-400 rounded p-3 text-green-400 hover:scale-105 duration-1000">
                  How It Works
                </p>
              </div>
            </div>
