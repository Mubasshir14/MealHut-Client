...
const selectCartMeals = (state: RootState) => state.cart.meals;
const selectMealProvider = (state: RootState) => state.cart.mealProvider || "";
const selectShippingAddress = (state: RootState) => state.cart.shippingAddress || "";
const selectSpecification = (state: RootState) => state.cart.specification || "";
const selectName = (state: RootState) => state.cart.name || "";

// Memoized transformed meals selector
const selectTransformedMeals = createSelector(
  [selectCartMeals],
...
export const orderSelector = createSelector(
  [
    selectTransformedMeals,
    selectMealProvider,
    selectShippingAddress,
    selectSpecification,
    selectName
  ],
  (meals, mealProvider, shippingAddress, specification, name) => ({
    meals,
    mealProvider,
    shippingAddress,
    specification,
...
export const grandTotalSelector = createSelector(
  [subTotalSelector, shippingCostSelector, discountAmountSelector],
